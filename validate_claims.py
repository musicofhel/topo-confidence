...
CLAIMS: list[Claim] = [
    ...
    # ----- §6b Second sweep (EXP-69–78, 2026-05-07) -----
    Claim("fe447-resid-auroc", "FE447 OOF residualized DoM AUROC = 0.620 (length-independent signal)",
          "pathway11_h100/results/fe447_length_baseline.json",
          ["auroc_oof_residualized_dom"], 0.6198619717858801, 0.005, "1024tok"),
    Claim("fe447-length-auroc", "FE447 length-as-predictor AUROC (negated) = 0.799",
          "pathway11_h100/results/fe447_length_baseline.json",
          ["auroc_length_negative"], 0.7986021040495749, 0.005, "1024tok"),
    Claim("fe447-spearman", "FE447 Spearman(DoM, seq_len) = -0.619",
          "pathway11_h100/results/fe447_length_baseline.json",
          ["spearman_dom_seqlen"], -0.6193580166418883, 0.005, "1024tok"),
    Claim("fe188-best-auroc", "FE188 LID-MLE best AUROC = 0.535 (k=20, negated); NOT a correctness predictor",
          "pathway11_h100/results/fe188_lid_mle.json",
          ["results_per_k", "20", "best_auroc"], 0.5345310723607308, 0.005, "1024tok"),
    Claim("fe421-ridge-concat-auroc", "FE421 Ridge-LR concat (3072-d) OOF AUROC = 0.851",
          "pathway11_h100/results/fe421_regularized_concat.json",
          ["ridge_lr", "concat_3072", "auroc_oof"], 0.8508750860674769, 0.005, "1024tok"),
    Claim("fe421-ridge-final-auroc", "FE421 Ridge-LR final-only (1536-d) OOF AUROC = 0.849 — nearly matches concat",
          "pathway11_h100/results/fe421_regularized_concat.json",
          ["ridge_lr", "final_1536", "auroc_oof"], 0.8493218683447823, 0.005, "1024tok"),
    Claim("fe421-ridge-prefill-auroc", "FE421 Ridge-LR prefill-only (1536-d) OOF AUROC = 0.784",
          "pathway11_h100/results/fe421_regularized_concat.json",
          ["ridge_lr", "prefill_1536", "auroc_oof"], 0.7844390001761381, 0.005, "1024tok"),
    Claim("fe421-dom-concat", "FE421 DoM concat (3072-d) AUROC = 0.757 (baseline)",
          "pathway11_h100/results/fe421_regularized_concat.json",
          ["dom_baselines", "concat_3072"], 0.7574258218443259, 0.005, "1024tok"),
    Claim("fe421-dom-prefill", "FE421 DoM prefill-only (1536-d) AUROC = 0.770",
          "pathway11_h100/results/fe421_regularized_concat.json",
          ["dom_baselines", "prefill_1536"], 0.7698675761797249, 0.005, "1024tok"),
    Claim("fe421-dom-final", "FE421 DoM final-only (1536-d) AUROC = 0.721",
          "pathway11_h100/results/fe421_regularized_concat.json",
          ["dom_baselines", "final_1536"], 0.7209972618532929, 0.005, "1024tok"),
    Claim("fe15-pr-global", "FE15 global PR = 19.86 (cross-check with FE01172B)",
          "pathway11_h100/results/fe15_length_band_pr.json",
          ["pr_global"], 19.861175537109375, 0.05, "1024tok"),
    Claim("fe15-short-auroc", "FE15 short-band DoM AUROC (in-sample) = 0.828",
          "pathway11_h100/results/fe15_length_band_pr.json",
          ["band_results", "short", "dom_auroc_insample"], 0.8276190476190476, 0.005, "1024tok"),
    Claim("fe15-medium-auroc", "FE15 medium-band DoM AUROC (in-sample) = 0.752",
          "pathway11_h100/results/fe15_length_band_pr.json",
          ["band_results", "medium", "dom_auroc_insample"], 0.7518095238095238, 0.005, "1024tok"),
    Claim("fe16-pr-corrected-all", "FE16 MP-corrected PR (all samples) = 18.93",
          "pathway11_h100/results/fe16_mp_bias_pr.json",
          ["all_samples", "pr_corrected"], 18.929438833735563, 0.05, "1024tok"),
    Claim("fe16-pr-corrected-correct", "FE16 MP-corrected PR (correct only) = 18.52",
          "pathway11_h100/results/fe16_mp_bias_pr.json",
          ["correct_only", "pr_corrected"], 18.517150444097176, 0.05, "1024tok"),
    Claim("fe16-pr-corrected-incorrect", "FE16 MP-corrected PR (incorrect only) = 19.63",
          "pathway11_h100/results/fe16_mp_bias_pr.json",
          ["incorrect_only", "pr_corrected"], 19.63062742701701, 0.05, "1024tok"),
    Claim("fe428-l0-auroc", "FE428 L0 DoM AUROC (OOF) = 0.500 — exactly chance; zero signal at embedding",
          "pathway11_h100/results/fe428_l0_embedding_dom.json",
          ["auroc_L0_dom_oof"], 0.5, 0.005, "1024tok"),
    Claim("fe428-cos-l0-l19", "FE428 cos(DoM_L0, DoM_L19) = 0.0 — embedding DoM unrelated to L19 DoM",
          "pathway11_h100/results/fe428_l0_embedding_dom.json",
          ["cos_dom_L0_L19"], 0.0, 0.005, "1024tok"),
    Claim("fe428-pr-l0", "FE428 PR at L0 = 0.0 (degenerate embedding layer)",
          "pathway11_h100/results/fe428_l0_embedding_dom.json",
          ["pr_L0"], 0.0, 0.005, "1024tok"),
    Claim("fe416-cos-prefinal-prefill", "FE416 cos(prefinal DoM, prefill DoM) = -0.054 (< 0.3 threshold); NOT positional artifact",
          "pathway11_h100/results/fe416_prefinal_token_dom.json",
          ["cosines", "prefinal_vs_prefill"], -0.05378629267215729, 0.005, "1024tok"),
    Claim("fe416-cos-prefinal-final", "FE416 cos(prefinal DoM, final DoM) = 0.717; rotation is gradual",
          "pathway11_h100/results/fe416_prefinal_token_dom.json",
          ["cosines", "prefinal_vs_final"], 0.717437744140625, 0.005, "1024tok"),
    Claim("fe416-auroc-prefinal", "FE416 prefinal (pos -2) DoM AUROC = 0.736",
          "pathway11_h100/results/fe416_prefinal_token_dom.json",
          ["aurocs", "prefinal_pos_minus2"], 0.7364013386495012, 0.005, "1024tok"),
    Claim("fe119-cos-l19", "FE119 cos(prefill DoM, final DoM) at L19 = -0.062",
          "pathway11_h100/results/fe119_layer_sweep_cos.json",
          ["cos_at_L19"], -0.061728086322546005, 0.005, "1024tok"),
    Claim("fe119-max-cos", "FE119 max cos across all 29 layers = 0.103 at L28; no layer has high alignment",
          "pathway11_h100/results/fe119_layer_sweep_cos.json",
          ["max_cos_value"], 0.10257567465305328, 0.005, "1024tok"),
    Claim("fe308-cache-k1-acc", "FE308 cache K=1 accuracy = 0.416 (T>0 sampling degrades vs greedy 0.486)",
          "pathway11_h100/results/fe308_adaptive_bestofk.json",
          ["cache_k1_accuracy"], 0.416, 0.005, "1024tok"),
    Claim("fe308-uniform-k8-acc", "FE308 uniform K=8 majority accuracy = 0.404 (lower than K=1)",
          "pathway11_h100/results/fe308_adaptive_bestofk.json",
          ["uniform_baselines", "8", "accuracy"], 0.40383, 0.005, "1024tok"),
    Claim("fe308-greedy-k1-acc", "FE308 canonical greedy K=1 accuracy = 0.486",
          "pathway11_h100/results/fe308_adaptive_bestofk.json",
          ["canonical_k1_greedy_accuracy"], 0.486, 0.005, "1024tok"),
    ...
    Claim("fe459-spearman", "FE459 Spearman(1.5B scores, 7B scores) = 0.937 — universal difficulty geometry",
          "pathway11_h100/results/fe459_cross_model_dom.json",
          ["cross_model", "spearman_rho"], 0.9367761631046523, 0.005, "1024tok"),
    Claim("fe459-7b-n-correct", "FE459 7B correct = 366/500 (73.2%)",
          "pathway11_h100/results/fe459_cross_model_dom.json",
          ["model_7b", "n_correct"], 366, 0.5, "1024tok"),
    ...
    # ----- §v7 "Ship the Gate, Then Try to Beat It" (EXP-84..87, 2026-06-12) -----
    # Phase 1a (zero-cost arms + spectral-alpha closure), Phase 1b (cost-matched
    # bake-off), deviation D-3 (BBH cache n_gen_tokens all-zero -> honest-gate
    # sensitivity), Phase 2 (pseudo-label adaptation). T5/P1c claims land when
    # results/v7_phase1c_t5.json does.
    Claim("edge-v7-1a-free-math", "v7 dev free gate (len+logprob) 1.5B MATH OOF AUROC 0.849 (in-domain protocol, not LOCO)",
          "pathway11_h100/generalization_edge/results/v7_phase1a.json",
          ["math", "free_gate_oof_auroc"], 0.8490176298217804, 1e-6, "1024tok"),
    Claim("edge-v7-1a-free-bbh", "v7 dev free gate 1.5B BBH OOF AUROC 0.782 (de facto logprob-only per D-3)",
          "pathway11_h100/generalization_edge/results/v7_phase1a.json",
          ["bbh", "free_gate_oof_auroc"], 0.7823068483041878, 1e-6, "1024tok",
          note="D-3: cache n_gen_tokens degenerate; honest gate is edge-v7-d3-honest-bbh"),
    Claim("edge-v7-1a-hk-delta", "H-K REFUTED: prefill-alpha+length vs length-only delta -0.0206 (alpha subtracts; spectral-alpha CLOSED)",
          "pathway11_h100/generalization_edge/results/v7_phase1a.json",
          ["alpha_closure_HK", "incremental_delta"], -0.020568125410321714, 1e-6, "1024tok"),
    Claim("edge-v7-1a-hk-p", "H-K refutation DeLong p=0.017 (significant harm)",
          "pathway11_h100/generalization_edge/results/v7_phase1a.json",
          ["alpha_closure_HK", "delong_p"], 0.01673885056181046, 1e-6, "1024tok"),
    Claim("edge-v7-1b-hi-bbh-entropy-delta", "Phase1b pinned-gate H-I refuter: mean_token_entropy +0.0151 on BBH at rel_cost 1.0 (reclassified artifact under D-3)",
          "pathway11_h100/generalization_edge/results/v7_phase1b_costmatched.json",
          ["H_I", "qwen1.5b_bbh", "refuted_by", 0, "incremental_delta"], 0.015050150986998578, 1e-6, "1024tok",
          note="superseded by edge-v7-d3-entropy-honest: -0.0004 over honest gate"),
    Claim("edge-v7-1b-hj-k8-majority", "H-J: K=8 majority accuracy 0.554 at full-escalation cost where cascade hits 0.732 (K loses everywhere)",
          "pathway11_h100/generalization_edge/results/v7_phase1b_costmatched.json",
          ["H_J_math", "k_points", 2, "acc_k_majority_full_cov"], 0.554, 1e-9, "1024tok"),
    Claim("edge-v7-1b-hj-cascade-at-k8-cost", "H-J comparator: cascade accuracy 0.732 at the K=8 cost point",
          "pathway11_h100/generalization_edge/results/v7_phase1b_costmatched.json",
          ["H_J_math", "k_points", 2, "acc_cascade_full_cov"], 0.732, 1e-9, "1024tok"),
    Claim("edge-v7-1b-ptrue-fmtB", "P(True) fmtB 1.5B MATH dev standalone AUROC 0.538 (frozen for T5 over fmtA 0.502; near-chance at 1.5B)",
          "pathway11_h100/generalization_edge/results/v7_phase1b_costmatched.json",
          ["ptrue_format_frozen_for_T5", "dev_aurocs", "ptrue_fmtB"], 0.5381419032521497, 1e-6, "1024tok"),
    Claim("edge-v7-d3-honest-bbh", "D-3 honest BBH free gate (real sidecar lengths) OOF AUROC 0.806 (pinned 0.782 was logprob-only)",
          "pathway11_h100/generalization_edge/results/v7_bbh_length_sensitivity.json",
          ["honest_free_gate_auroc_real_length"], 0.8060569575391547, 1e-6, "1024tok"),
    Claim("edge-v7-d3-honest-transfer", "D-3 honest MATH->BBH zero-shot transfer AUROC 0.828 (pinned 0.785 anchor understated by ~4pp)",
          "pathway11_h100/generalization_edge/results/v7_bbh_length_sensitivity.json",
          ["honest_math_to_bbh_transfer_auroc"], 0.8276903358611114, 1e-6, "1024tok"),
    Claim("edge-v7-d3-entropy-honest", "H-I HOLDS honest: mean_token_entropy adds -0.0004 over honest BBH gate (the +0.0151 was a missing-length proxy)",
          "pathway11_h100/generalization_edge/results/v7_bbh_length_sensitivity.json",
          ["entropy_vs_honest_gate", "incremental_delta"], -0.00037868121838269264, 1e-6, "1024tok"),
    Claim("edge-v7-2-hl1-noise-wol", "H-L1 REFUTED: K=8 pseudo-label noise rate 0.388 on confirmatory web_of_lies (threshold transfer fails)",
          "pathway11_h100/generalization_edge/results/v7_phase2_pseudolabel.json",
          ["guards", "k8_web_of_lies", "noise_rate"], 0.388, 1e-9, "1024tok"),
    Claim("edge-v7-2-hl3-precision", "H-L3 CONFIRMED: cross-model pseudo-label precision 0.951 (7B greedy == 1.5B K=8 modal); conformal validity >=0.9 all 4 live cells",
          "pathway11_h100/generalization_edge/results/v7_phase2_pseudolabel.json",
          ["H_L3_crossscale", "pseudo_label_guard", "precision"], 0.9509433962264151, 1e-6, "1024tok"),
    Claim("edge-v7-4-cascade-acc", "Phase4 operating point: free-gate cascade OOF acc 0.648 at esc-0.5 matched cost (oracle 0.758, gap 11.0pp)",
          "pathway11_h100/generalization_edge/results/v7_phase4_router.json",
          ["operating_point", "acc_cascade_free_gate"], 0.648, 1e-9, "1024tok"),
    Claim("edge-v7-4-hm-delta", "H-M REFUTED: nested-OOF router delta vs cascade -0.40pp at matched cost (p=0.68; cascade-as-is ships)",
          "pathway11_h100/generalization_edge/results/v7_phase4_router.json",
          ["router", "delta_vs_cascade"], -0.0040000000000000036, 1e-9, "1024tok"),
    Claim("edge-v7-4-prm-auroc", "PRM-7B prm_mean standalone AUROC 0.940 on 1.5B MATH (excellent verifier, resolves P11-FE403 signal question)",
          "pathway11_h100/generalization_edge/results/v7_phase4_router.json",
          ["prm_descriptive", "arms", 1, "standalone_auroc"], 0.9396006469071752, 1e-6, "1024tok"),
    Claim("edge-v7-4-prm-relcost", "PRM-7B scoring costs 1.042x a full 7B escalation per transcript (cost-dominated as a routing signal)",
          "pathway11_h100/generalization_edge/results/v7_phase4_router.json",
          ["prm_descriptive", "rel_cost_vs_escalation"], 1.0419139668673418, 1e-6, "1024tok"),
    Claim("edge-v7-t5-smollm2-free", "P1c confirmatory: SmolLM2 free gate OOF 0.808 through the v7 harness (v6 pin 0.810 reproduces)",
          "pathway11_h100/generalization_edge/results/v7_phase1c_t5.json",
          ["families", "smollm2", "free_gate_oof_auroc"], 0.8083182640144666, 1e-6, "1024tok"),
    Claim("edge-v7-t5-gemma-free", "P1c confirmatory: Gemma free gate OOF 0.842 through the v7 harness",
          "pathway11_h100/generalization_edge/results/v7_phase1c_t5.json",
          ["families", "gemma", "free_gate_oof_auroc"], 0.8422379032258065, 1e-6, "1024tok"),
    Claim("edge-v7-t5-olmo2-free", "P1c confirmatory: OLMo-2 free gate OOF 0.836 through the v7 harness",
          "pathway11_h100/generalization_edge/results/v7_phase1c_t5.json",
          ["families", "olmo2", "free_gate_oof_auroc"], 0.8357190098261527, 1e-6, "1024tok"),
    Claim("edge-v7-t5-hi-holds", "H-I HOLDS at confirmatory T5: no arm beats the free gate at <=1.05x cost in any held-out family (entropy no-harm passes all three)",
          "pathway11_h100/generalization_edge/results/v7_phase1c_t5.json",
          ["H_I_t5", "holds"], True, 0, "1024tok"),
