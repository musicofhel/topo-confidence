...
TAGS: list[str] = [
    ...
    "length_confound", "selective_prediction", "self_consistency",
    "cross_domain", "cross_scale", "intrinsic_dimension", "neural_collapse",
    "linear_probing", "test_time_compute", "distillation",
    "direction_rotation", "truncation_artifact",
]

FINDING_TAGS: dict[str, list[str]] = {
    "F-1":  ["breathing", "neural_collapse", "intrinsic_dimension"],
    "F-2":  ["prefill", "linear_probing", "calibration"],
    "F-3":  ["direction_rotation", "steering"],
    "F-4":  ["linear_probing", "prefill", "length_confound"],
    "F-5":  ["cross_scale", "prefill"],
    "F-6":  ["CoE", "cross_domain"],
    "F-7":  ["PH", "intrinsic_dimension"],
    "F-8":  ["PH", "CoE"],
    "F-9":  ["length_confound"],
    "F-10": ["intrinsic_dimension"],
    "F-11": ["selective_prediction", "calibration", "prefill"],
    "F-12": ["self_consistency", "test_time_compute"],
    "F-13": ["truncation_artifact"],
    "F-14": ["self_consistency", "test_time_compute", "prefill"],
}

PAPER_TAGS: dict[str, list[str]] = {
    "2410.13640": ["CoE", "linear_probing"],
    ...
    "2506.18831": ["steering", "direction_rotation"],
    "2407.12404": ["steering", "direction_rotation"],
    "2509.06608": ["steering", "direction_rotation"],
    "2310.06824": ["linear_probing", "calibration"],
    "2410.02707": ["prefill", "linear_probing"],
    "2402.18048": ["intrinsic_dimension", "calibration"],
    "2410.11042": ["PH"],
    "2111.13171": ["PH", "intrinsic_dimension"],
    "2402.03744": ["D2H", "calibration"],
    "2509.11569": ["D2H", "calibration"],
    "2506.24106": ["D2H"],
    "2406.15927": ["selective_prediction", "calibration"],
    "2505.21772": ["calibration"],
    "2604.20614": ["calibration", "selective_prediction"],
    "2405.17767": ["neural_collapse", "cross_scale"],
    "2302.00294": ["intrinsic_dimension", "neural_collapse"],
    "2405.15471": ["intrinsic_dimension", "breathing"],
    "2203.11171": ["self_consistency", "test_time_compute"],
    "2502.06703": ["test_time_compute"],
    "2501.04519": ["test_time_compute"],
